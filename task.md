...
- [x] Restaurar arquitectura de datos unificada (db.json array)
- [x] Corregir renderizado de componentes y sincronización con Zustand
- [x] Estabilizar tests E2E y asegurar que pasen (3/3 OK)
