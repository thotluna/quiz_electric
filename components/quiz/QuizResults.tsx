        ...
        <div className="bg-surface-card rounded-none md:rounded-[2.5rem] p-4 md:p-12 shadow-2xl border-x-0 border-y md:border border-foreground/5 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-4 md:space-y-8">
            ...
            <div className="flex flex-col items-center py-2 md:py-4 w-full max-w-sm">
              <div className="relative w-32 h-16 md:w-56 md:h-28 mb-6 md:mb-10">
                <svg viewBox="0 0 100 50" className="w-full h-full overflow-visible">
                  ...
                  <path d="M 10 50 A 40 40 0 0 1 90 50" fill="none" stroke="var(--color-status-correct)" strokeWidth="12" strokeDasharray={`${(correctCount / totalQuestions) * 125.6} 125.6`} strokeLinecap="round" className="transition-all duration-1000 ease-out" />
              ...
              <div className="flex flex-col items-center mb-6 md:mb-8">
                ...
                <span className="text-[8px] md:text-[10px] font-bold text-foreground/30 uppercase tracking-widest mt-1">Puntaje Normalizado</span>
              </div>
            ...
            <div className="w-full grid grid-cols-3 lg:grid-cols-6 gap-y-6 md:gap-4 py-6 md:py-8 border-y border-foreground/5">
              ...
              <div className="space-y-0.5 md:border-l border-foreground/5">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {userAnswers
                ...
                .map((answer, index) => {
                  const correctOptions = answer.question.opciones.filter(o => answer.correctIds?.includes(o.id));
